...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<CaptchaGeetest>[] is M) {
      return data.map<CaptchaGeetest>((Map<String, dynamic> e) =>
          CaptchaGeetest.fromJson(e)).toList() as M;
    }
    if (<CaptchaTencent>[] is M) {
      return data.map<CaptchaTencent>((Map<String, dynamic> e) =>
          CaptchaTencent.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendEntity>[] is M) {
      return data.map<LiveRecommendEntity>((Map<String, dynamic> e) =>
          LiveRecommendEntity.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendList>[] is M) {
      return data.map<LiveRecommendList>((Map<String, dynamic> e) =>
          LiveRecommendList.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendListPendantInfo>[] is M) {
      return data.map<LiveRecommendListPendantInfo>((Map<String, dynamic> e) =>
          LiveRecommendListPendantInfo.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendListPendantInfo2>[] is M) {
      return data.map<LiveRecommendListPendantInfo2>((Map<String, dynamic> e) =>
          LiveRecommendListPendantInfo2.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendListVerify>[] is M) {
      return data.map<LiveRecommendListVerify>((Map<String, dynamic> e) =>
          LiveRecommendListVerify.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendListHeadBox>[] is M) {
      return data.map<LiveRecommendListHeadBox>((Map<String, dynamic> e) =>
          LiveRecommendListHeadBox.fromJson(e)).toList() as M;
    }
    if (<LiveRecommendListWatchedShow>[] is M) {
    ...
    if (<WebKeyEntity>[] is M) {
      return data.map<WebKeyEntity>((Map<String, dynamic> e) =>
          WebKeyEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (CaptchaGeetest).toString(): CaptchaGeetest.fromJson,
    (CaptchaTencent).toString(): CaptchaTencent.fromJson,
    (LiveRecommendEntity).toString(): LiveRecommendEntity.fromJson,
    (LiveRecommendList).toString(): LiveRecommendList.fromJson,
    (LiveRecommendListPendantInfo).toString(): LiveRecommendListPendantInfo
        .fromJson,
    (LiveRecommendListPendantInfo2).toString(): LiveRecommendListPendantInfo2
        .fromJson,
    (LiveRecommendListVerify).toString(): LiveRecommendListVerify.fromJson,
    ...
    (VideoDetailsHonorReplyHonor).toString(): VideoDetailsHonorReplyHonor
        .fromJson,
    (WebKeyEntity).toString(): WebKeyEntity.fromJson,
  };
